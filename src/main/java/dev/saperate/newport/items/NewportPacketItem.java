...
public class NewportPacketItem extends Item {

    public NewportPacketItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (emptyPacket(itemStack, 1)) {
            if(!user.getInventory().insertStack(NewportItems.NEWPORT_CIG_ITEM_0.getDefaultStack())){
    ...
    public ItemStack getDefaultStack() {
        ...
        NewportPacketItem item = (NewportPacketItem) stack.getItem();
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        SapsUtils.addTranslatable(tooltip, "item.newport.newport_packet.tooltip", getCigLevel(itemStack));
    }
